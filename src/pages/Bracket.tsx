...
// Visual order for R32: adjacent pairs feed the same octavo (73+75→R16-89, 74+77→R16-90, …)
const ROUND_OF_32_ORDER = [73, 75, 74, 77, 76, 78, 79, 80, 83, 84, 81, 82, 87, 86, 85, 88]
