    ...
    <div className="min-h-screen bg-gradient-navy flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-union-navy-light border border-union-blue/20 rounded-2xl p-6 shadow-2xl">
          <h2 className="text-xl font-semibold text-white mb-5">Iniciar sesión</h2>

          {/* Social auth */}
          <div className="space-y-2 mb-5">
            <button
              onClick={signInWithGoogle}
              className="w-full flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg px-4 py-2.5 text-white text-sm font-medium transition-colors"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-[#1877F2]/10 hover:bg-[#1877F2]/20 border border-[#1877F2]/30 rounded-lg px-4 py-2.5 text-white text-sm font-medium transition-colors"
            >
          ...
          <p className="text-center text-sm text-white/40 mt-5">
            ¿No tenés cuenta?{' '}
            <Link to="/register" className="text-union-blue hover:text-union-blue-light font-medium">Registrate</Link>
          </p>
        </div>
      </div>
    </div>
