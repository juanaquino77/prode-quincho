...
const SECTIONS = [
  ...
  {
    emoji: '🎯',
    title: 'Sistema de puntos — Fase de grupos',
    table: [
      { accion: 'Resultado exacto (ej: predijiste 2-1 y salió 2-1)',             pts: '+3 pts' },
      { accion: 'Ganador/empate acertado sin resultado exacto',                   pts: '+1 pt'  },
      { accion: 'Predicciones especiales (campeón, goleador, MVP)',               pts: '+2 pts c/u' },
      { accion: '💛 Corazonada: acertás el marcador EXACTO del partido elegido',  pts: '5 pts total' },
    ],
    note: 'La Corazonada da 5 pts TOTALES si acertás el marcador exacto (reemplaza los 3 pts normales). Si solo acertás el resultado sin el marcador exacto, sumás 1 pt como siempre.',
  },
  {
    emoji: '⚔️',
    title: 'Sistema de puntos — Fase eliminatoria',
    items: [
      '📌 El resultado final es siempre el marcador al término de los 90\' + tiempo suplementario (no penales).',
      '',
      '✅ VICTORIA en tiempo reglamentario o suplementario:',
      '   • Acertás el ganador: +1 pt',
      '   • Acertás el marcador exacto: +3 pts',
      '',
      '🤝 EMPATE (el partido va a penales):',
      '   Cuando pronosticás empate, el sistema te pide quién ganará en penales.',
      '   • Empate exacto + acertás penales → 3 + 1 = 4 pts',
      '   • Empate exacto + errás penales  → 3 − 1 = 2 pts',
      '   • Empate (no exacto) + acertás penales → 1 + 1 = 2 pts',
      '   • Empate (no exacto) + errás penales  → solo 1 pt (sin descuento)',
      '',
      '💛 CORAZONADA en eliminatorias:',
      '   Si la marcás y acertás el marcador exacto → 5 pts SIEMPRE (ignora penales y descuentos).',
      '   • 1 corazonada disponible en Ronda de 32',
      '   • 1 corazonada disponible en Octavos de final',
      '   • 1 corazonada disponible en Cuartos de final',
      '   • Semifinales y Final NO tienen corazonada.',
    ],
  },
  {
    emoji: '💛',
    title: 'Corazonada — Resumen',
    items: [
      'Grupos: 1 Corazonada por grupo (12 en total). Si acertás el marcador exacto → 5 pts totales.',
      'Ronda de 32: 1 Corazonada para toda esa fase.',
      'Octavos de final: 1 Corazonada para toda esa fase.',
      'Cuartos de final: 1 Corazonada para toda esa fase.',
      'Semifinales y Final: sin Corazonada.',
      'La Corazonada NO suma bonus si solo acertás el ganador sin el marcador exacto.',
    ],
  },
  {
    emoji: '📅',
