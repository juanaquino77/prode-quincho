-- ============================================================
-- PRODE QUINCHO - Migration 062
-- Corrige lógica is_cold: hielo si los últimos 3 partidos = 0 puntos
-- MANTIENE: is_active = true, paid, free_pass, is_hot sin cambios
-- ============================================================
