-- Migration 054 — Agregar has_special_predictions a admin_list_tournament_members
--
-- Permite mostrar en el panel admin quién cargó pronósticos de partidos
-- pero todavía NO cargó los pronósticos especiales (campeón, goleador, MVP).
