...
--   • 4 cruces 1° vs 2°  (entre grupos no adyacentes)
--   • 4 cruces 2° vs 2°
--   • 8 cruces 1° vs Mejor 3°  (con tabla de posibles grupos)
--   • 16 partidos totales en round_of_32 (antes había 14)
-- Fuente: https://en.wikipedia.org/wiki/2026_FIFA_World_Cup_knockout_stage
-- ============================================================

-- ── 1. Actualizar los 14 partidos de round_of_32 existentes ──────────────────

UPDATE public.matches SET home_team = '2° Grupo A', away_team = '2° Grupo B'
  WHERE match_number = 73 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo E', away_team = 'Mejor 3° (A/B/C/D/F)'
  WHERE match_number = 74 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo F', away_team = '2° Grupo C'
  WHERE match_number = 75 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo C', away_team = '2° Grupo F'
  WHERE match_number = 76 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo I', away_team = 'Mejor 3° (C/D/F/G/H)'
  WHERE match_number = 77 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '2° Grupo E', away_team = '2° Grupo I'
  WHERE match_number = 78 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo A', away_team = 'Mejor 3° (C/E/F/H/I)'
  WHERE match_number = 79 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo L', away_team = 'Mejor 3° (E/H/I/J/K)'
  WHERE match_number = 80 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo D', away_team = 'Mejor 3° (B/E/F/I/J)'
  WHERE match_number = 81 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo G', away_team = 'Mejor 3° (A/E/H/I/J)'
  WHERE match_number = 82 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '2° Grupo K', away_team = '2° Grupo L'
  WHERE match_number = 83 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo H', away_team = '2° Grupo J'
  WHERE match_number = 84 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '1° Grupo B', away_team = 'Mejor 3° (E/F/G/I/J)'
  WHERE match_number = 85 AND competition = 'mundial_2026';

UPDATE public.matches SET home_team = '2° Grupo D', away_team = '2° Grupo G'
  WHERE match_number = 86 AND competition = 'mundial_2026';

-- ── 2. Insertar los 2 partidos faltantes (87 y 88) del round_of_32 ───────────
--    Los actuales matches 87-94 (round_of_16) se renumeran abajo.
...
-- ── 3. Renumerar round_of_16 (87-94 → 89-96) y usar formato "Gan. #N" ────────
...
-- ── 4. Renumerar cuartos (95-98 → 97-100) y usar "Gan. #N" ──────────────────
...
-- ── 5. Renumerar semis (99-100 → 101-102) ────────────────────────────────────
...
-- ── 6. Renumerar 3er puesto y final ──────────────────────────────────────────
