...
-- Restaura get_leaderboard con filtro is_active = true
-- (se perdió en migraciones 057/058/060 al redefinir la función)
-- IMPORTANTE: cualquier redefinición futura DEBE incluir
--   AND tm.is_active = true  en el WHERE de tournament_members
-- ============================================================
